...
import UseProductDetail from '../../Hooks/UsePorductDetails';
                ...
                <div className='addtocart'>
                    ...
                    <div className='pt-3 pb-4 addtocart-form'>
                        <form onSubmit={handlePlaceOrder} >
                            ...
                            <br />
                            <input type="text" name='orderQuentity' class="input mb-3" placeholder='Product Quentity' defaultValue={1} required />
                            <br />
